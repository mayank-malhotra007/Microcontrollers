      ...
      PerformBBCode: function(TextArea, Operation) {
         ...
         switch (Operation) {
            ...
            case 'youtube':
                ...
                var PromptText = gdn.definition('ButtonBarYouTube', 'ButtonBar.YouTubeT');
                NewURL = prompt(PromptText);
                thisOpts.replace = NewURL;

                $(TextArea).insertRoundTag('youtube',thisOpts);
                break;

            case 'color':
                 var thisOpts = $.extend(bbcodeOpts, {});

                 var PromptText = gdn.definition('ButtonBarColor', 'ButtonBar.ColorT');
                 ...
                 $(TextArea).insertRoundTag('color',thisOpts);
                 break;

            case 'indent':
                 $(TextArea).insertRoundTag('indent',bbcodeOpts);
                 break;
