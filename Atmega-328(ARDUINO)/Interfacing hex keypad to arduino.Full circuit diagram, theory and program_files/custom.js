...
jQuery(document).ready(function ($) {
    ...
    // SP script (Toggle comments on small screens)
    jQuery('.sm-toggle-comments').click(function(){
        jQuery('.comments-area').slideToggle('slow');
        jQuery('.sm-toggle-comments').html(jQuery('.sm-toggle-comments').text() == 'Hide Comments' ? 'Show Comments' : 'Hide Comments');
    });
